package com.ptc.core.com.ptc.windchill.enterprise.associativity.asb.dataUtilities;
...
public class EquivalenceNetworkDataUtility extends AbstractAttributeDataUtility {
    ...
    private String formLinkForViewName(String var1, String var2) {
        return "<a target=\"_blank\" href=\"" + var2 + "\">" + HTMLEncoder.encodeAndFormatForHTMLContent(var1) + "</a>";
    }
}
